...
{
    public class CreateEnderecoCommandHandler : IRequestHandler<CreateEnderecoCommand, ValidationResult>
    {
        public CreateEnderecoCommandHandler(IEnderecoRepository repository, IMediator mediator)
        {
        ...
        public async Task<ValidationResult> Handle(CreateEnderecoCommand request, CancellationToken cancellationToken)
        {
