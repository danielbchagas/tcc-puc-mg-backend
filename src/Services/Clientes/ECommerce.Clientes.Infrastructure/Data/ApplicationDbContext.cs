...
namespace ECommerce.Clientes.Infrastructure.Data
{
    public class ApplicationDbContext : DbContext, IUnitOfWork
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var cliente1 = new Cliente(id: Guid.NewGuid(), nomeFantasia: "Farmácia Santa Lúcia", cnpj: "41.822.341/0001-20", endereco: endereco1);
            var cliente2 = new Cliente(id: Guid.NewGuid(), nomeFantasia: "Farmácia Pacheco", cnpj: "20.188.964/0001-12", endereco: endereco2);
            var cliente3 = new Cliente(id: Guid.NewGuid(), nomeFantasia: "Farmácia Mônica", cnpj: "55.142.194/0001-51", endereco: endereco3);
            var cliente4 = new Cliente(id: Guid.NewGuid(), nomeFantasia: "Farmácia Ultrafarma", cnpj: "29.614.369/0001-76", endereco: endereco4);
            var cliente5 = new Cliente(id: Guid.NewGuid(), nomeFantasia: "Farmácia Preço Baixo", cnpj: "77.749.871/0001-37", endereco: endereco5);
