...
namespace ECommerce.WebApi.Core.Extensions
{
    ...
    {
        public static void AddEntityFrameworkConfiguration<TDbContext>(this IServiceCollection services, IConfiguration configuration) where TDbContext : DbContext
        {
