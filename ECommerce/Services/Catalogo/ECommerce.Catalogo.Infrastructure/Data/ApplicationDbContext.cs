    ...
    public class ApplicationDbContext : DbContext, IUnitOfWork
    {
        ...
        private void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Produto>().HasData(
                ...
                produtoCamisetaChelsea,
                produtoCamisetaManCity,
                produtoCamisetaCroacia
            );
        }
    }
}
